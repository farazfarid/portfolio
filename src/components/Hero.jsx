    ...
    <section className={`relative w-full h-screen mx-auto`}>
      ...
      >
        <div className="flex flex-col justify-center items-center mt-5">
          <div className="w-5 h-5 rounded-full bg-gradient-to-b from-red-800  to-red-700" />
          <div className="w-1 sm:h-80 h-40 bg-gradient-to-b from-red-700 via-violet-800 to-blue-900" />
        </div>
